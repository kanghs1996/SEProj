...
public class StringBasic {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("[new연산자 사용]");
		System.out.println("== 로 주소비교:"+(str1==str2));
		//String클래스의 equals()메소드(Object로 부터 상속받은 메소드)
		//실제 저장된 문자열을 비교하도록 오버라이딩됨]
		System.out.println("equals() 로 주소비교:"+(str1.equals(str2)));
		...
		String str3="WORLD";
		String str4="WORLD";
		System.out.println("[new연산자 미 사용]");
		System.out.println("== 로 주소비교:"+(str3==str4));
		System.out.println("equals() 로 주소비교:"+(str3.equals(str4)));
		/*
		...
		String str5="Hello";
		String str6="HELLO";
		System.out.println("== 로 주소비교:"+(str5==str6));
		//[대소문자 구분해서 비교-equals()메소드]
		System.out.println("equals()메소드로 문자열 비교:"+(str5.equals(str6)));
		//[대소문자 구분하지 않고 비교-equalsIgnoreCase()메소드]
		System.out.println("equalsIgnoreCase()메소드로 문자열 비교:"+(str5.equalsIgnoreCase(str6)));
		/*
